            ...
            <div className='container'>
                <div className='row mb-5'>
                    ...
                    <div className='col-md-3 pb-4'>
                        ...
                        <div className='pt-3 pe-5'>Lorem ipsum dolor sit amet.</div>
                    </div>
                    <div className='col-md-3 pb-4'>
                    ...
                    <div className='col-md-3'>
                        ...
                        <ul>
                            <li>
                                <a href="#">+62 8XXXXXXXX</a>
                            </li>
                            <li>
                                <a href="#">ksatriyau@gmail.com</a>
                            </li>
                        </ul>
                    </div>
               <div className='row spotlight py-5'>
                ...
                <div className='col-md-4'>
                    ...
                    <h3 className='ps-2'>Secource Payment</h3>
                    </div>
                </div>
               </div>
                </div>
                <div className='row'>
                    <div className='col-md-12 text-center pt-3'>
                        <p>&copy; 2025 Ksatriyau and Pian</p>
                    </div>
                </div>
            </div>
        </footer>
